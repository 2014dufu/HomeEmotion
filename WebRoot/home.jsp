  ...
  <body>
 	...
 	<div id="video_div">
 		...
 		<div class="video_file_div">
 			<a href="player.jsp"><img src="images/video/1.png" /></a>
 	...
 	<div id="video_ranking_div">
 		...
 		<ul class="rank_ul">
 			<li><div class="number_div">1</div><span><a href="player.jsp">天眼传奇</a></span></li>
 			<li><div class="number_div">2</div><span><a href="player.jsp">神雕侠女</a></span></li>
 		</ul>
 	</div>
 	<div id="music_div">
 		<div class="title_div">
		...
		<div class="one_div">
			<p>闲聊</p>
			<ul id="audio_ul">
	 			<li class="old_li"><a href="language.jsp">Cro Magnon Man</a></li>
 	...
 	<div id="music_ranking_div">
 		<div class="rank_title_div">
 			<span class="title_span">热门推荐</span>
 			 	<ul class="rank_ul">
 				<li><div class="number_div">1</div><span><a href="language.jsp">Cro Magnon Man</a></span></li>
 	...
 	<div id="picture_div">
 		<div class="title_div">
 			...
 			<div class="scenery_div">
 				...
 				<a href="scenery.jsp"><img src="images/scenery/6.jpg" /></a>
 				<div class="detail_div"><span class="picture_name_span">小谢</span><span class="piture_date_span">2016/02/09</span></div>
 			</div>
 			</div>
 	...
 	<div id="picture_ranking_div">
 		<div class="rank_title_div">
 			...
 			<ul class="rank_ul">
 				<li><div class="number_div">1</div><span><a href="scenery.jsp">橘子洲风光</a></span></li>
 				<li><div class="number_div">2</div><span><a href="scenery.jsp">岳麓山风光</a></span></li>
 			</ul>
 		</div>
 	</div>
 	<div class="clear"></div>
